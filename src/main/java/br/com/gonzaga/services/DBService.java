...
public class DBService {
	...
	@Autowired BCryptPasswordEncoder bCripty;
	...
	public void instantiateDatabase() throws Exception{
		...
		cat1.getProdutos().addAll(Arrays.asList(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12, p13, p14, p15, p16, p17, p18, p19, p20,
...
//		p3.getCategorias().addAll(Arrays.asList(cat1));
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","maria@gmail.com","36378912377", TipoCliente.PESSOA_FISICA,bCripty.encode("123"));
